 ...
 * 
 */
package com.test.automation.uiAutomation.TC_BCEHS_PreAdmission;
...
import com.test.automation.uiAutomation.BCEHS_PreAdmission.Admission_Form_BCEHS_BaldwinURL;
 ...
 *
 */
public class Tc_Admission_Form_BCEHS_BaldwinURL extends TestBase {

	
	public static final Logger log = Logger.getLogger(Tc_Admission_Form_BCEHS_BaldwinURL.class.getName());

	Admission_Form_BCEHS_BaldwinURL bcehsForm_BaldwinURL;
	...
	public void setUp() throws IOException {
		init();
		bcehsForm_BaldwinURL = new Admission_Form_BCEHS_BaldwinURL(driver);
	...
	public void tcHomeButtonValidation() {
		...
		try {
			...
			boolean status = bcehsForm_BaldwinURL.verifyHomeButton();
			Assert.assertEquals(status, true);
	...
	public void tcNavigateToAdmission_Form_BCEHS() {
		...
		try {
			...
			bcehsForm_BaldwinURL.navigateToAdmission_Form_BCEHS();
	...
	public void tcVerifyAdmission_Form_BCEHSPage() {
		...
		try {
			...
			boolean status = bcehsForm_BaldwinURL.verifyAdmission_Form_BCEHSPage();
			Assert.assertEquals(status, true);
	...
	public void enterStudentInformationFor_BCEHSPreAdmForm(String fName, String mName, String sName, String mNumber,
		...
		try {
			...
			bcehsForm_BaldwinURL.enterStudentInformationFor_BCEHSPreAdmForm(fName, mName, sName, mNumber, birthPlace, religion,
	...
	public void tcOthersDetailsForBcehsAdmForm(String Language2, String Language3, String tribe, String playGroup,
		...
		try {
			...
			bcehsForm_BaldwinURL.othersDetailsForBcehsAdmForm(Language2, Language3, tribe, playGroup);
	...
	public void tcResidentialAndPermanentAddress(String street, String area, String Country, String state, String city,
		...
		try {
			...
			bcehsForm_BaldwinURL.residentialAndPermanentAddress(street, area, Country, state, city, pinZip);
	...
	public void tcFathersDetails_BCEHSPreAdmissionForm(String fatherName, String fatherSurName,
		...
		try {
			...
			bcehsForm_BaldwinURL.fathersDetails_BCEHSPreAdmissionForm(fatherName, fatherSurName, fatherQualification,
	...
	public void tcMothersDetails_BCEHSPreAdmissionForm(String motherName, String motherSurName,
		...
		try {
			...
			bcehsForm_BaldwinURL.mothersDetails_BCEHSPreAdmissionForm(motherName, motherSurName, motherQualification,
	...
	public void tcMonthlyIncomeDetailsBCEHS(String fatherIncome, String motherIncome, String altContact,
		...
		try {
			...
			bcehsForm_BaldwinURL.monthlyIncomeDetailsBCEHS(fatherIncome, motherIncome, altContact, altEmail);
	...
	public void tcGurdianDetailsBCEHSPreAdm(String guardianName, String gurdianRelWithStu, String gurdianOccupation,
		...
		try {
			...
			bcehsForm_BaldwinURL.gurdianDetailsBCEHSPreAdm(guardianName, gurdianRelWithStu, gurdianOccupation, guardianPhoneOffice,
					guardianPhRes);
	...
	public void tcSiblingdetailsBCEHSPreAdm(String siblingName, String siblingClass, String siblingAdmNo,
		...
		try {
			...
			bcehsForm_BaldwinURL.siblingdetailsBCEHSPreAdm(siblingName, siblingClass, siblingAdmNo);
	...
	public void tcUploadfatherAndMotherPhotos() {
		...
		try {
			...
			bcehsForm_BaldwinURL.uploadfatherAndMotherPhotos();
	...
	public void tcPreviousSchoolDetailsBCEHS(String prevSchoolName, String prevClass, String prevGrade,
		...
		try {
			...
			bcehsForm_BaldwinURL.previousSchoolDetailsBCEHS(prevSchoolName, prevClass, prevGrade, prevPassedYr, PrevAddress);
	...
	public void tcUploadRequiredDetails() {
		...
		try {
			...
			bcehsForm_BaldwinURL.uploadRequiredDetails();
	...
	public void tcValidationOfUploadedDOBCertificate() {
		...
		try {
			...
			bcehsForm_BaldwinURL.validationOfUploadedDOBCertificate();
	...
	public void tcClickOnPopupCloseButtonForDOBCert() {
		...
		try {
			...
			bcehsForm_BaldwinURL.clickOnPopupCloseButton();
	...
	public void tcValidationOfUploadedAddressProofCertificate() {
		...
		try {
			...
			bcehsForm_BaldwinURL.validationOfUploadedAddressProofCertificate();
	...
	public void tcVerifyUndertakingText(String textToVerify) {
		...
		try {
			...
			bcehsForm_BaldwinURL.verifyUndertakingText(textToVerify);
	...
	public void tcConfirmUndertakingYes() {
		...
		try {
			...
			bcehsForm_BaldwinURL.confirmUndertakingYes();
	...
	public void tcClickOnSubmitButton() {
		...
		try {
			...
			bcehsForm_BaldwinURL.clickOnSubmitButton();
	...
	public void tcPopUpValidationCancel() {
		...
		try {
			...
			bcehsForm_BaldwinURL.popUpValidationCancel();
	...
	public void tcPopUpValidationYes() {
		...
		try {
			...
			bcehsForm_BaldwinURL.popUpValidationYes();
	...
	public void tcSearchByFatherNameInGridFor_PayRegistrationFee(String FatherName, String runMode) {
		...
		try {
			...
			bcehsForm_BaldwinURL.searchByFatherNameInGrid(FatherName);
	...
	public void tcVerifyFatherNameInStudentListGrid_PayRegistrationFee_BCEHSForm(String FatherName, String runMode) {
		...
		try {
			...
			bcehsForm_BaldwinURL.verifyFatherNameInStudentListGrid(FatherName);
	...
	public void tcSearchWithFatherNameInStudentListGrid__PayRegistrationFee_BCEHSForm(String FatherName,
		...
		try {
			...
			bcehsForm_BaldwinURL.searchWithFatherNameInStudentListGrid__PayRegistrationFee_BCEHSForm(FatherName);
			log.info(
	...
	public void tcBack_PayRegistrationFee() {
		...
		try {
			...
			bcehsForm_BaldwinURL.back_PayRegistrationFee();
	...
	public void tcSearchWithFatherNameInStudentListGrid_Edit_BCEHSForm(String FatherName, String runMode) {
		...
		try {
			...
			bcehsForm_BaldwinURL.searchWithFatherNameInStudentListGrid_Edit_BCEHSForm(FatherName);
	...
	public void tcSelctionOfSubmitActionForEdit() {
		...
		try {
			...
			bcehsForm_BaldwinURL.selctionOfSubmitActionForEdit();
	...
	public void tcSearchWithFatherNameInStudentListGrid_DownLoadProspectus_BCEHS_AdmissionForm(String FatherName,
		...
		try {
			...
			bcehsForm_BaldwinURL.searchWithFatherNameInStudentListGrid_DownLoadProspectus_BCEHS_AdmissionForm(FatherName);
			log.info(
	...
	public void tcSwitchWindowsForProspectusDownload() {
		...
		try {
			...
			bcehsForm_BaldwinURL.switchWindowsForProspectusDownload();
	...
	public void tcSearchWithFatherNameInStudentListGrid_View_BCEHS_AdmissionForm(String FatherName, String runMode) {
		...
		try {
			...
			bcehsForm_BaldwinURL.searchWithFatherNameInStudentListGrid_View_BCEHS_AdmissionForm(FatherName);
			log.info(
	...
	public void tcCloseOpenAdmissionForm() {
		...
		try {
			...
			bcehsForm_BaldwinURL.closeOpenAdmissionForm();
	...
	public void tcPrintOpenAdmissionForm() {
		...
		try {
			...
			bcehsForm_BaldwinURL.printOpenAdmissionForm();
	...
	public void tcswitchToWindowUsingTab() {
		...
		try {
			...
			bcehsForm_BaldwinURL.switchToWindowUsingTab();
