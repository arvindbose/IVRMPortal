 ...
 * 
 */
package com.test.automation.uiAutomation.TC_Staging_PreAdmission;
...
import com.test.automation.uiAutomation.Staging_PreAdmission.PreAdmission_OralTest_Schedule_AutoSelect12Hr_Staging;
 ...
 *
 */
public class TC_PreAdmission_OralTest_Schedule_AutoSelect12Hr_Staging extends TestBase {

	public static final Logger log = Logger
			.getLogger(TC_PreAdmission_OralTest_Schedule_AutoSelect12Hr_Staging.class.getName());

	PreAdmission_OralTest_Schedule_AutoSelect12Hr_Staging oralTestSchedule_Staging;
	...
	public void setUp() throws IOException {
		init();
		oralTestSchedule_Staging = new PreAdmission_OralTest_Schedule_AutoSelect12Hr_Staging(driver);
	...
	public void tcHomeButtonValidation() {
		...
		try {
			...
			boolean status = oralTestSchedule_Staging.verifyHomeButton();
			Assert.assertEquals(status, true);
	...
	public void tcNavigateToOralTestSchedule_BGHS() {
		try {
			...
			oralTestSchedule_Staging.navigateToOralTestSchedule_BGHS();
	...
	public void tcVerifyInterviewSchedule_BGHSPage() {
		...
		try {
			...
			boolean status = oralTestSchedule_Staging.verifyInterviewSchedule_BGHSPage();
			Assert.assertEquals(status, true);
	...
	public void tcOralTestScheduleInfo(String scheduleName, String scheduleDate, String remarks, String supervisor,
		...
		try {
			...
			oralTestSchedule_Staging.oralTestScheduleInfo(scheduleName, scheduleDate, remarks, supervisor, skill,
	...
	public void tcResetMinimizeAndMaximize() {
		...
		try {
			...
			oralTestSchedule_Staging.resetMinimizeAndMaximize();
	...
	public void tcOralTestScheduleInfoAfterReset(String scheduleName, String scheduleDate, String remarks,
	...
	public void tcClickOnSaveButton() {
		...
		try {
			...
			oralTestSchedule_Staging.clickOnSaveButton();
	...
	public void tcPopUpValidationOnSuccess() {
		...
		try {
			...
			oralTestSchedule_Staging.popUpValidationOnSuccess();
	...
	public void tcValidationOf12HourTimeFormatScheduleList() {
		...
		try {
			...
			oralTestSchedule_Staging.validationOf12HourTimeFormatScheduleList();
	...
	public void tcValidationOf24HourTimeFormatScheduleList() {
		...
		try {
			...
			oralTestSchedule_Staging.validationOf24HourTimeFormatScheduleList();
	...
	public void tcSortingUsingColumnHeader() {
		...
		try {
			...
			oralTestSchedule_Staging.sortingUsingColumnHeader();
	...
	public void tcSearchWithScheduleNameInScheduleList(String scheduleName, String runMode) {
		...
		try {
			...
			oralTestSchedule_Staging.searchWithScheduleNameInScheduleList(scheduleName);
	...
	public void tcVerifyscheduleNameInOralTestScheduleListGrid(String scheduleName, String runMode) {
		...
		try {
			...
			oralTestSchedule_Staging.verifyscheduleNameInOralTestScheduleListGrid(scheduleName);
	...
	public void tcDeleteScheduledOralTest(String scheduleName, String runMode) {
		...
		try {
			...
			oralTestSchedule_Staging.deleteScheduledOralTest(scheduleName);
	...
	public void tcCancellationOfDelete() {
		...
		try {
			...
			oralTestSchedule_Staging.cancellationOfDelete();
	...
	public void tcYesDeleteItButtonClick() {
		try {
			...
			oralTestSchedule_Staging.yesDeleteItButtonClick();
