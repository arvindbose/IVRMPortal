...
import com.vapsTechnosoft.IVRM.Admission.Masters.Masters_Master_Activities;
...
public class TC_Masters_Master_Activities extends TestBase{
	...
	public void tcPopUpWindowMessage_SubmitSuccessfully_Validation() {
		...
		try {
			...
			masteractivities.popWindowMessage_SubmitSuccessfully();
	...
	@Test(priority = 19, dataProvider = "MasterActivitiesSearchData")
	...
	public void tcPopWindowMessage_SubmitSuccessfully_Edit_Validation() {
		...
		try {
			...
			masteractivities.popWindowMessage_SubmitSuccessfully_Edit();
	...
	@Test(priority = 23, dataProvider = "MasterActivitiesSearchData")
	...
	@Test(priority = 24, dataProvider = "MasterActivitiesSearchData")
