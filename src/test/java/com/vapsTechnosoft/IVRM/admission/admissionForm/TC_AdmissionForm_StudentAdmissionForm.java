...
public class TC_AdmissionForm_StudentAdmissionForm extends TestBase {
	...
	@DataProvider(name = "AsPerConfigurationDob_Data")
	public String[][] getTestDobData() {
		String[][] testRecordsDOBData = getData("StudentAdmissionFormData.xlsx", "DOB_ActualConfBasedData");
		return testRecordsDOBData;
	}

	@DataProvider(name = "ForLessThanRequiredAge_Data")
	public String[][] getTestDobData_Less() {
		String[][] testRecordsDOBData_Less = getData("StudentAdmissionFormData.xlsx", "DOB__ForLessThanRequiredAge");
		return testRecordsDOBData_Less;
	}

	@DataProvider(name = "ForGreaterThanRequiredAge_Data")
	public String[][] getTestDobData_Greater() {
		String[][] testRecordsDOBData_Greater = getData("StudentAdmissionFormData.xlsx",
				"DOB_ForGreaterThanRequiredAge");
		return testRecordsDOBData_Greater;
	}
	...
	public void tcNavigateToAdmission_AdmissionForm_StudentAdmissionForm_BGHS() {
		...
		try {
			log.info(
					"============= Starting tcNavigateToAdmission_AdmissionForm_StudentAdmissionForm_BGHS Test===========");

			studentadmissionform.navigateToAdmission_AdmissionForm_StudentAdmissionForm_BGHS();

			log.info(
					"============= Finished tcNavigateToAdmission_AdmissionForm_StudentAdmissionForm_BGHS Test===========");
	...
	@Test(priority = 6, dataProvider = "ForLessThanRequiredAge_Data")
	public void tcSelectClassForAdm_And_DateofBirth_ForLessThanRequiredAge(String classForAdm,
			String dobLessThanEligible, String lessThanEligibleAge, String runMode) {
		...
		try {
			log.info(
					"============= Starting tcSelectClassForAdm_And_DateofBirth_ForLessThanRequiredAge Test===========");

			studentadmissionform.selectClassForAdm_And_DateofBirth_ForLessThanRequiredAge(classForAdm,
					dobLessThanEligible, lessThanEligibleAge);

			log.info(
					"============= Finished tcSelectClassForAdm_And_DateofBirth_ForLessThanRequiredAge Test===========");
			getScreenShot("tcSelectClassForAdm_And_DateofBirth_ForLessThanRequiredAge");
		} catch (Exception e) {
			getScreenShot("tcSelectClassForAdm_And_DateofBirth_ForLessThanRequiredAge");
		}
	}
	...
	@Test(priority = 7)
	public void tcClearAllFilledFieldInStudentAdmissionForm_ForLessThanRequiredAge() {

		try {
			log.info(
					"============= Starting tcClearAllFilledFieldInStudentAdmissionForm_ForLessThanRequiredAge Test===========");

			studentadmissionform.clearAllFilledFieldInStudentAdmissionForm();

			log.info(
					"============= Finished tcClearAllFilledFieldInStudentAdmissionForm_ForLessThanRequiredAge Test===========");
			getScreenShot("tcClearAllFilledFieldInStudentAdmissionForm_ForLessThanRequiredAge");
		} catch (Exception e) {
			getScreenShot("tcClearAllFilledFieldInStudentAdmissionForm_ForLessThanRequiredAge");
		}
	}

	@Test(priority = 8, dataProvider = "ForGreaterThanRequiredAge_Data")
	public void tcSelectClassForAdm_And_DateofBirth_ForGreaterThanRequiredAge(String classForAdm,
			String dobGreaterThanEligible, String greaterThanEligibleAge, String runMode) {
		...
		try {
			log.info(
					"============= Starting tcSelectClassForAdm_And_DateofBirth_ForGreaterThanRequiredAge Test===========");

			studentadmissionform.selectClassForAdm_And_DateofBirth_ForGreaterThanRequiredAge(classForAdm,
					dobGreaterThanEligible, greaterThanEligibleAge);

			log.info(
					"============= Finished tcSelectClassForAdm_And_DateofBirth_ForGreaterThanRequiredAge Test===========");
			getScreenShot("tcSelectClassForAdm_And_DateofBirth_ForGreaterThanRequiredAge");
		} catch (Exception e) {
			getScreenShot("tcSelectClassForAdm_And_DateofBirth_ForGreaterThanRequiredAge");
		}
	}
	...
	@Test(priority = 9)
	public void tcClearAllFilledFieldInStudentAdmissionForm_ForGreaterThanRequiredAge() {

		try {
			log.info(
					"============= Starting tcClearAllFilledFieldInStudentAdmissionForm_ForGreaterThanRequiredAge Test===========");

			studentadmissionform.clearAllFilledFieldInStudentAdmissionForm();

			log.info(
					"============= Finished tcClearAllFilledFieldInStudentAdmissionForm_ForGreaterThanRequiredAge Test===========");
			getScreenShot("tcClearAllFilledFieldInStudentAdmissionForm_ForGreaterThanRequiredAge");
		} catch (Exception e) {
			getScreenShot("tcClearAllFilledFieldInStudentAdmissionForm_ForGreaterThanRequiredAge");
		}
	}

	@Test(priority = 10, dataProvider = "AsPerConfigurationDob_Data")
	public void tcSelectClassForAdm_And_DateofBirth(String classForAdm, String dateOfBirth, String runMode) {

		if (runMode.equalsIgnoreCase("n")) {
			throw new SkipException("user marked this record as no run");
		}
		try {
			log.info("============= Starting tcSelectClassForAdm_And_DateofBirth Test===========");

			studentadmissionform.selectClassForAdm_And_DateofBirth(classForAdm, dateOfBirth);

			log.info("============= Finished tcSelectClassForAdm_And_DateofBirth Test===========");
			getScreenShot("tcSelectClassForAdm_And_DateofBirth");
		} catch (Exception e) {
			getScreenShot("tcSelectClassForAdm_And_DateofBirth");
		}
	}

	@Test(priority = 11, dataProvider = "AdmStudentAdmForm_Left")
	public void tcEnterStudentDetailsForStudentAdmForm_LeftPart(String firstName, String middleName, String lastName,
		...
		try {
			...
			studentadmissionform.enterStudentDetailsForStudentAdmForm_LeftPart(firstName, middleName, lastName,
					academicYr, regNumber, admissionNum, casteCategory, caste, subCaste, bankIfscCode, birthPlace,
					birthCertificate, casteCertificate);
	...
	@Test(priority = 12, dataProvider = "AdmStudentAdmForm_Right")
	...
	@Test(priority = 20, dataProvider = "AsPerConfigurationDob_Data")
	public void tcSelectClassForAdm_And_DateofBirth_AfterCancel(String classForAdm, String dateOfBirth,
			String runMode) {
	...
	@Test(priority = 21, dataProvider = "AdmStudentAdmForm_Left")
	public void tcEnterStudentDetailsForStudentAdmForm_LeftPart_AfterClear(String firstName, String middleName,
			String lastName, String academicYr, String regNumber, String admissionNum, String casteCategory,
			String caste, String subCaste, String bankIfscCode, String birthPlace, String birthCertificate,
			String casteCertificate, String runMode) {
	...
	@Test(priority = 22, dataProvider = "AdmStudentAdmForm_Right")
	...
	@Test(priority = 25)
	public void tcPopUPWindowMessage_SubmitSuccessfully_StudentDetails() {

		try {
			log.info("============= Starting tcPopUPWindowMessage_SubmitSuccessfully_StudentDetails Test===========");

			studentadmissionform.popWindowMessage_SubmitSuccessfully();
			;

			log.info("============= Finished tcPopUPWindowMessage_SubmitSuccessfully_StudentDetails Test===========");
			getScreenShot("tcPopUPWindowMessage_SubmitSuccessfully_StudentDetails");
		} catch (Exception e) {
			getScreenShot("tcPopUPWindowMessage_SubmitSuccessfully_StudentDetails");
		}
	}
	...
	@Test(priority = 26)
	public void tcClickOnOkSuccessButton_StudentDetails() {

		try {
			log.info("============= Starting tcClickOnOkSuccessButton_StudentDetails Test===========");

			studentadmissionform.clickOnOkSuccessButton();

			log.info("============= Finished tcClickOnOkSuccessButton_StudentDetails Test===========");
			getScreenShot("tcClickOnOkSuccessButton_StudentDetails");
		} catch (Exception e) {
			getScreenShot("tcClickOnOkSuccessButton_StudentDetails");
		}
	}
	...
	@Test(priority = 28, dataProvider = "StudentAdmForm_Address")
	...
	@Test(priority = 32)
	public void tcPopUPWindowMessage_SubmitSuccessfully_StudentDetailsToAddr() {

		try {
			log.info(
					"============= Starting tcPopUPWindowMessage_SubmitSuccessfully_StudentDetailsToAddr Test===========");

			studentadmissionform.popWindowMessage_SubmitSuccessfully_Edit();
			;

			log.info(
					"============= Finished tcPopUPWindowMessage_SubmitSuccessfully_StudentDetailsToAddr Test===========");
			getScreenShot("tcPopUPWindowMessage_SubmitSuccessfully_StudentDetailsToAddr");
		} catch (Exception e) {
			getScreenShot("tcPopUPWindowMessage_SubmitSuccessfully_StudentDetailsToAddr");
		}
	}
	@Test(priority = 33)
	public void tcClickOnOkSuccessButton_StudentDetailsToAddr() {

		try {
			log.info("============= Starting tcClickOnOkSuccessButton_StudentDetailsToAddr Test===========");

			studentadmissionform.clickOnOkSuccessButton();

			log.info("============= Finished tcClickOnOkSuccessButton_StudentDetailsToAddr Test===========");
			getScreenShot("tcClickOnOkSuccessButton_StudentDetailsToAddr");
		} catch (Exception e) {
			getScreenShot("tcClickOnOkSuccessButton_StudentDetailsToAddr");
		}
	}
	@Test(priority = 34, dataProvider = "StudentAdmForm_Address")
	...
	@Test(priority = 36)
	public void tcPopUPWindowMessage_SubmitSuccessfully_Address() {

		try {
			log.info("============= Starting tcPopUPWindowMessage_SubmitSuccessfully_Address Test===========");

			studentadmissionform.popWindowMessage_SubmitSuccessfully();

			log.info("============= Finished tcPopUPWindowMessage_SubmitSuccessfully_Address Test===========");
			getScreenShot("tcPopUPWindowMessage_SubmitSuccessfully_Address");
		} catch (Exception e) {
			getScreenShot("tcPopUPWindowMessage_SubmitSuccessfully_Address");
		}
	}
	...
	@Test(priority = 37)
	public void tcClickOnOkSuccessButton_Address() {

		try {
			log.info("============= Starting tcClickOnOkSuccessButton_Address Test===========");

			studentadmissionform.clickOnOkSuccessButton();

			log.info("============= Finished tcClickOnOkSuccessButton_Address Test===========");
			getScreenShot("tcClickOnOkSuccessButton_Address");
		} catch (Exception e) {
			getScreenShot("tcClickOnOkSuccessButton_Address");
		}
	}
	...
	//
	// try {
	// log.info("============= Starting tcSelectFatherAliveCheckBox
	// Test===========");
	//
	// studentadmissionform.selectFatherAliveCheckBox();
	//
	// log.info("============= Finished tcSelectFatherAliveCheckBox
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcSubmitBlankParentsForm
	// Test===========");
	//
	// studentadmissionform.submitBlankParentsForm();
	//
	// log.info("============= Finished tcSubmitBlankParentsForm
	// Test===========");
	...
	// public void tcEnterFatherDetailsInParentsPage(String fatherName, String
	// fatherSurName, String f_AadharNo,
	// String f_Qualification, String f_OfficeAddr, String f_Occupation, String
	// f_Designation, String f_AccountNo,
	// String f_IFSCCode, String f_CasteCertNo, String f_Nationality, String
	// f_Religion, String f_Caste,
	// String f_SubCaste, String f_MonthlyIncome, String f_AnnualIncome, String
	// f_MobileNumber, String f_EmailId,
	// String runMode) {
	//
	// if (runMode.equalsIgnoreCase("n")) {
	// throw new SkipException("user marked this record as no run");
	// }
	// try {
	// log.info("============= Starting tcEnterFatherDetailsInParentsPage
	// Test===========");
	//
	// studentadmissionform.enterFatherDetailsInParentsPage(fatherName,
	// fatherSurName, f_AadharNo, f_Qualification,
	// f_OfficeAddr, f_Occupation, f_Designation, f_AccountNo, f_IFSCCode,
	// f_CasteCertNo, f_Nationality,
	// f_Religion, f_Caste, f_SubCaste, f_MonthlyIncome, f_AnnualIncome,
	// f_MobileNumber, f_EmailId);
	//
	// log.info("============= Finished tcEnterFatherDetailsInParentsPage
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcSelectMotherAliveCheckBox
	// Test===========");
	//
	// studentadmissionform.selectMotherAliveCheckBox();
	//
	// log.info("============= Finished tcSelectMotherAliveCheckBox
	// Test===========");
	...
	// public void tcEnterMotherDetailsInParentsPage(String motherName, String
	// motherSurName, String m_AadharNo,
	// String m_Qualification, String m_OfficeAddr, String m_Occupation, String
	// m_Designation, String m_AccountNo,
	// String m_IFSCCode, String m_CasteCertNo, String m_Nationality, String
	// m_Religion, String m_Caste,
	// String m_SubCaste, String m_MonthlyIncome, String m_AnnualIncome, String
	// m_MobileNumber, String m_EmailId,
	// String runMode) {
	//
	// if (runMode.equalsIgnoreCase("n")) {
	// throw new SkipException("user marked this record as no run");
	// }
	// try {
	// log.info("============= Starting tcEnterMotherDetailsInParentsPage
	// Test===========");
	//
	// studentadmissionform.enterMotherDetailsInParentsPage(motherName,
	// motherSurName, m_AadharNo, m_Qualification,
	// m_OfficeAddr, m_Occupation, m_Designation, m_AccountNo, m_IFSCCode,
	// m_CasteCertNo, m_Nationality,
	// m_Religion, m_Caste, m_SubCaste, m_MonthlyIncome, m_AnnualIncome,
	// m_MobileNumber, m_EmailId);
	//
	// log.info("============= Finished tcEnterMotherDetailsInParentsPage
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcClearFilledParentsDetails
	// Test===========");
	//
	// studentadmissionform.clearFilledParentsDetails();
	//
	// log.info("============= Finished tcClearFilledParentsDetails
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcClickOnPreviousButtonToGoBackToAddressPage Test===========");
	//
	...
	// @Test(priority = 33)
	// public void
	// tcClickOnNextToSwitchFromAddressToParentsPage_AfterPreviousAddress() {
	//
	// try {
	// log.info(
	// "============= Starting
	...
	//
	// try {
	// log.info("============= Starting tcSelectFatherAliveCheckBox_AfterClear
	// Test===========");
	//
	// studentadmissionform.selectFatherAliveCheckBox();
	//
	// log.info("============= Finished tcSelectFatherAliveCheckBox_AfterClear
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcSubmitBlankParentsForm_AfterClear
	// Test===========");
	//
	// studentadmissionform.submitBlankParentsForm();
	//
	// log.info("============= Finished tcSubmitBlankParentsForm_AfterClear
	// Test===========");
	...
	// public void tcEnterFatherDetailsInParentsPage_AfterClear(String
	// fatherName, String fatherSurName, String f_AadharNo,
	// String f_Qualification, String f_OfficeAddr, String f_Occupation, String
	// f_Designation, String f_AccountNo,
	// String f_IFSCCode, String f_CasteCertNo, String f_Nationality, String
	// f_Religion, String f_Caste,
	...
	// try {
	// log.info("============= Starting
	// tcEnterFatherDetailsInParentsPage_AfterClear Test===========");
	//
	// studentadmissionform.enterFatherDetailsInParentsPage(fatherName,
	// fatherSurName, f_AadharNo, f_Qualification,
	// f_OfficeAddr, f_Occupation, f_Designation, f_AccountNo, f_IFSCCode,
	...
	//
	// try {
	// log.info("============= Starting tcSelectMotherAliveCheckBox_AfterClear
	// Test===========");
	//
	// studentadmissionform.selectMotherAliveCheckBox();
	//
	// log.info("============= Finished tcSelectMotherAliveCheckBox_AfterClear
	// Test===========");
	...
	// public void tcEnterMotherDetailsInParentsPage_AfterClear(String
	// motherName, String motherSurName, String m_AadharNo,
	// String m_Qualification, String m_OfficeAddr, String m_Occupation, String
	// m_Designation, String m_AccountNo,
	// String m_IFSCCode, String m_CasteCertNo, String m_Nationality, String
	// m_Religion, String m_Caste,
	...
	// try {
	// log.info("============= Starting
	// tcEnterMotherDetailsInParentsPage_AfterClear Test===========");
	//
	// studentadmissionform.enterMotherDetailsInParentsPage(motherName,
	// motherSurName, m_AadharNo, m_Qualification,
	// m_OfficeAddr, m_Occupation, m_Designation, m_AccountNo, m_IFSCCode,
	...
	// try {
	// log.info("============= Starting
	// tcClickOnNextToSwitchFromParentsToOthersPage Test===========");
	//
	...
	// public void tcEnterAchievementsDetails(String achievements, String
	// runMode) {
	//
	// try {
	// log.info("============= Starting tcEnterAchievementsDetails
	// Test===========");
	//
	// studentadmissionform.enterAchievementsDetails(achievements);
	//
	// log.info("============= Finished tcEnterAchievementsDetails
	// Test===========");
	...
	// public void tcSelectBondAndFillWithBondNumber(String bondName, String
	// bondNumber, String runMode) {
	//
	// try {
	// log.info("============= Starting tcSelectBondAndFillWithBondNumber
	// Test===========");
	//
	// studentadmissionform.selectBondAndFillWithBondNumber(bondName,
	// bondNumber);
	//
	// log.info("============= Finished tcSelectBondAndFillWithBondNumber
	// Test===========");
	...
	// }
	//
	// @Test(priority = 45, dataProvider =
	// "StudentAdmForm_Others_PreviousSchool")
	// public void tcEnterPreviousSchoolDetails(String schoolName, String
	// schoolType, String preClass, String percentage,
	// String grade, String passedYear, String totalMarks, String board, String
	// country, String state,
	// String address, String leftReason, String medium, String runMode) {
	//
	// try {
	// log.info("============= Starting tcEnterPreviousSchoolDetails
	// Test===========");
	//
	// studentadmissionform.enterPreviousSchoolDetails(schoolName, schoolType,
	// preClass, percentage, grade,
	// passedYear, totalMarks, board, country, state, address, leftReason,
	// medium);
	//
	// log.info("============= Finished tcEnterPreviousSchoolDetails
	// Test===========");
	...
	// public void tcEnterGuardianDetails(String guardianName, String
	// guardianAddress, String guardianEmail,
	// String guardianPhone, String runMode) {
	//
	// try {
	// log.info("============= Starting tcEnterGuardianDetails
	// Test===========");
	//
	// studentadmissionform.enterGuardianDetails(guardianName, guardianAddress,
	// guardianEmail, guardianPhone);
	// ;
	//
	// log.info("============= Finished tcEnterGuardianDetails
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcUploadGuardianSignature
	// Test===========");
	//
	// studentadmissionform.uploadGuardianSignature();
	//
	// log.info("============= Finished tcUploadGuardianSignature
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcUploadGuardianFingerPrint
	// Test===========");
	//
	// studentadmissionform.uploadGuardianFingerPrint();
	//
	// log.info("============= Finished tcUploadGuardianFingerPrint
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedGuardianPhoto
	// Test===========");
	//
	// studentadmissionform.viewUploadedGuardianPhoto();
	//
	// log.info("============= Finished tcViewUploadedGuardianPhoto
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_GuardianPhoto Test===========");
	//
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedGuardianSign
	// Test===========");
	//
	// studentadmissionform.viewUploadedGuardianSign();
	//
	// log.info("============= Finished tcViewUploadedGuardianSign
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_GuardianSign Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedGuardianFingerPrint
	// Test===========");
	//
	// studentadmissionform.viewUploadedGuardianFingerPrint();
	//
	// log.info("============= Finished tcViewUploadedGuardianFingerPrint
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_GuardianFingerPrint Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	// public void tcEnterSiblingDetails(String siblingName, String
	// siblingClass, String siblingRelation, String runMode) {
	//
	// try {
	// log.info("============= Starting tcEnterSiblingDetails Test===========");
	//
	// studentadmissionform.enterSiblingDetails(siblingName, siblingClass,
	// siblingRelation);
	//
	...
	//
	// try {
	// log.info("============= Starting tcClearFilledOthersDetails
	// Test===========");
	//
	// studentadmissionform.clearFilledOthersDetails();
	//
	// log.info("============= Finished tcClearFilledOthersDetails
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcClickOnPreviousButtonToGoBackToParentsPage Test===========");
	//
	...
	// @Test(priority = 59)
	// public void
	// tcClickOnNextToSwitchFromParentsToOthersPage_AfterClearOthers() {
	//
	// try {
	// log.info(
	// "============= Starting
	...
	//
	// try {
	// log.info("============= Starting tcSelectActivities_AfterClearOthers
	// Test===========");
	//
	// studentadmissionform.selectActivities();
	//
	// log.info("============= Finished tcSelectActivities_AfterClearOthers
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcSelectReference_AfterClearOthers
	// Test===========");
	//
	// studentadmissionform.selectReference();
	//
	// log.info("============= Finished tcSelectReference_AfterClearOthers
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcSelectSource_AfterClearOthers
	// Test===========");
	//
	// studentadmissionform.selectSource();
	//
	// log.info("============= Finished tcSelectSource_AfterClearOthers
	// Test===========");
	...
	// public void tcEnterAchievementsDetails_AfterClearOthers(String
	// achievements, String runMode) {
	//
	// try {
	// log.info("============= Starting
	// tcEnterAchievementsDetails_AfterClearOthers Test===========");
	//
	// studentadmissionform.enterAchievementsDetails(achievements);
	//
	// log.info("============= Finished
	...
	// public void tcSelectBondAndFillWithBondNumber_AfterClearOthers(String
	// bondName, String bondNumber, String runMode) {
	//
	// try {
	// log.info("============= Starting
	// tcSelectBondAndFillWithBondNumber_AfterClearOthers Test===========");
	//
	// studentadmissionform.selectBondAndFillWithBondNumber(bondName,
	// bondNumber);
	//
	...
	// }
	//
	// @Test(priority = 65, dataProvider =
	// "StudentAdmForm_Others_PreviousSchool")
	// public void tcEnterPreviousSchoolDetails_AfterClearOthers(String
	// schoolName, String schoolType, String preClass,
	// String percentage, String grade, String passedYear, String totalMarks,
	// String board, String country,
	// String state, String address, String leftReason, String medium, String
	// runMode) {
	//
	// try {
	// log.info("============= Starting
	// tcEnterPreviousSchoolDetails_AfterClearOthers Test===========");
	//
	// studentadmissionform.enterPreviousSchoolDetails(schoolName, schoolType,
	// preClass, percentage, grade,
	// passedYear, totalMarks, board, country, state, address, leftReason,
	...
	// public void tcEnterGuardianDetails_AfterClearOthers(String guardianName,
	// String guardianAddress,
	// String guardianEmail, String guardianPhone, String runMode) {
	//
	// try {
	// log.info("============= Starting tcEnterGuardianDetails_AfterClearOthers
	// Test===========");
	//
	// studentadmissionform.enterGuardianDetails(guardianName, guardianAddress,
	// guardianEmail, guardianPhone);
	// ;
	//
	// log.info("============= Finished tcEnterGuardianDetails_AfterClearOthers
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcUploadGuardianPhoto_AfterClearOthers
	// Test===========");
	//
	// studentadmissionform.uploadGuardianPhoto();
	//
	// log.info("============= Finished tcUploadGuardianPhoto_AfterClearOthers
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcUploadGuardianSignature_AfterClearOthers Test===========");
	//
	// studentadmissionform.uploadGuardianSignature();
	//
	// log.info("============= Finished
	...
	// try {
	// log.info("============= Starting
	// tcUploadGuardianFingerPrint_AfterClearOthers Test===========");
	//
	// studentadmissionform.uploadGuardianFingerPrint();
	//
	// log.info("============= Finished
	...
	// try {
	// log.info("============= Starting
	// tcViewUploadedGuardianPhoto_AfterClearOthers Test===========");
	//
	// studentadmissionform.viewUploadedGuardianPhoto();
	//
	// log.info("============= Finished
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_GuardianPhoto_AfterClear
	// Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	...
	// try {
	// log.info("============= Starting
	// tcViewUploadedGuardianSign_AfterClearOthers Test===========");
	//
	// studentadmissionform.viewUploadedGuardianSign();
	//
	// log.info("============= Finished
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_GuardianSign_AfterClear
	// Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	...
	// try {
	// log.info("============= Starting
	// tcViewUploadedGuardianFingerPrint_AfterClearOthers Test===========");
	//
	// studentadmissionform.viewUploadedGuardianFingerPrint();
	//
	// log.info("============= Finished
	...
	// @Test(priority = 75)
	// public void
	// tcCloseOpenedUploadedImagePopUp_GuardianFingerPrint_AfterClear() {
	//
	// try {
	// log.info(
	// "============= Starting
	...
	// public void tcEnterSiblingDetails_AfterClearOthers(String siblingName,
	// String siblingClass, String siblingRelation,
	// String runMode) {
	//
	// try {
	// log.info("============= Starting tcEnterSiblingDetails_AfterClearOthers
	// Test===========");
	//
	// studentadmissionform.enterSiblingDetails(siblingName, siblingClass,
	// siblingRelation);
	//
	// log.info("============= Finished tcEnterSiblingDetails_AfterClearOthers
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcClickOnNextToSwitchFromOthersToDocumentsPage Test===========");
	//
	...
	//
	// try {
	// log.info("============= Starting tcClickOnSubmitButton_Documents_Blank
	// Test===========");
	//
	// studentadmissionform.clickOnSubmitButton_Documents();
	//
	// log.info("============= Finished tcClickOnSubmitButton_Documents_Blank
	// Test===========");
	...
	// public void tcUploadDocumentCorrepondingToDocumentName(String
	// documentName, String runMode) {
	//
	// try {
	// log.info("============= Starting
	// tcUploadDocumentCorrepondingToDocumentName Test===========");
	//
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_DocumentUpload Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	//
	// try {
	// log.info("============= Starting tcRequiredDetailsInDocumentsPage
	// Test===========");
	//
	// studentadmissionform.requiredDetailsInDocumentsPage();
	//
	// log.info("============= Finished tcRequiredDetailsInDocumentsPage
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcUploadFatherFingerPrint
	// Test===========");
	//
	// studentadmissionform.uploadFatherFingerPrint();
	//
	// log.info("============= Finished tcUploadFatherFingerPrint
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedFatherPhoto
	// Test===========");
	//
	// studentadmissionform.viewUploadedFatherPhoto();
	//
	// log.info("============= Finished tcViewUploadedFatherPhoto
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_FatherPhoto Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedFatherSign
	// Test===========");
	//
	// studentadmissionform.viewUploadedFatherSign();
	//
	// log.info("============= Finished tcViewUploadedFatherSign
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_FatherSign Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedFatherFingerPrint
	// Test===========");
	//
	// studentadmissionform.viewUploadedFatherFingerPrint();
	//
	// log.info("============= Finished tcViewUploadedFatherFingerPrint
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_FatherFingerPrint Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	//
	// try {
	// log.info("============= Starting tcUploadMotherFingerPrint
	// Test===========");
	//
	// studentadmissionform.uploadMotherFingerPrint();
	//
	// log.info("============= Finished tcUploadMotherFingerPrint
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedMotherPhoto
	// Test===========");
	//
	// studentadmissionform.viewUploadedMotherPhoto();
	//
	// log.info("============= Finished tcViewUploadedMotherPhoto
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_MotherPhoto Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedMotherSign
	// Test===========");
	//
	// studentadmissionform.viewUploadedMotherSign();
	//
	// log.info("============= Finished tcViewUploadedMotherSign
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_MotherSign Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedMotherFingerPrint
	// Test===========");
	//
	// studentadmissionform.viewUploadedMotherFingerPrint();
	//
	// log.info("============= Finished tcViewUploadedMotherFingerPrint
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_MotherFingerPrint Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	//
	// try {
	// log.info("============= Starting tcClearFilledDocumentsDetails
	// Test===========");
	//
	// studentadmissionform.clearFilledDocumentsDetails();
	//
	// log.info("============= Finished tcClearFilledDocumentsDetails
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcClickOnPreviousButtonToGoBackToOthersPage Test===========");
	//
	...
	// @Test(priority = 102)
	// public void
	// tcClickOnNextToSwitchFromOthersToDocumentsPage_AfterClearDocuments() {
	//
	// try {
	// log.info(
	// "============= Starting
	...
	// try {
	// log.info("============= Starting
	// tcClickOnSubmitButton_Documents_Blank_AfterClear Test===========");
	//
	// studentadmissionform.clickOnSubmitButton_Documents();
	//
	// log.info("============= Finished
	...
	// public void tcUploadDocumentCorrepondingToDocumentName_AfterClear(String
	// documentName, String runMode) {
	//
	// try {
	// log.info("============= Starting
	// tcUploadDocumentCorrepondingToDocumentName_AfterClear Test===========");
	//
	// studentadmissionform.uploadDocumentCorrepondingToDocumentName(documentName);
	//
	// log.info("============= Finished
	...
	// log.info(
	// "============= Starting
	// tcCloseOpenedUploadedImagePopUp_DocumentUpload_AfterClear
	// Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	...
	// try {
	// log.info("============= Starting
	// tcRequiredDetailsInDocumentsPage_AfterClear Test===========");
	//
	// studentadmissionform.requiredDetailsInDocumentsPage();
	//
	// log.info("============= Finished
	...
	//
	// try {
	// log.info("============= Starting tcUploadFatherPhoto_AfterClear
	// Test===========");
	//
	// studentadmissionform.uploadFatherPhoto();
	//
	// log.info("============= Finished tcUploadFatherPhoto_AfterClear
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcUploadFatherSign_AfterClear
	// Test===========");
	//
	// studentadmissionform.uploadFatherSign();
	//
	// log.info("============= Finished tcUploadFatherSign_AfterClear
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcUploadFatherFingerPrint_AfterClear
	// Test===========");
	//
	// studentadmissionform.uploadFatherFingerPrint();
	//
	// log.info("============= Finished tcUploadFatherFingerPrint_AfterClear
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedFatherPhoto_AfterClear
	// Test===========");
	//
	// studentadmissionform.viewUploadedFatherPhoto();
	//
	// log.info("============= Finished tcViewUploadedFatherPhoto_AfterClear
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_FatherPhoto_AfterClear Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedFatherSign_AfterClear
	// Test===========");
	//
	// studentadmissionform.viewUploadedFatherSign();
	//
	// log.info("============= Finished tcViewUploadedFatherSign_AfterClear
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_FatherSign_AfterClear Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	// try {
	// log.info("============= Starting
	// tcViewUploadedFatherFingerPrint_AfterClear Test===========");
	//
	// studentadmissionform.viewUploadedFatherFingerPrint();
	//
	// log.info("============= Finished
	...
	// @Test(priority = 115)
	// public void
	// tcCloseOpenedUploadedImagePopUp_FatherFingerPrint_AfterClear() {
	//
	// try {
	// log.info(
	// "============= Starting
	...
	//
	// try {
	// log.info("============= Starting tcUploadMotherPhoto_AfterClear
	// Test===========");
	//
	// studentadmissionform.uploadMotherPhoto();
	//
	// log.info("============= Finished tcUploadMotherPhoto_AfterClear
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcUploadMotherSign_AfterClear
	// Test===========");
	//
	// studentadmissionform.uploadMotherSign();
	//
	// log.info("============= Finished tcUploadMotherSign_AfterClear
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcUploadMotherFingerPrint_AfterClear
	// Test===========");
	//
	// studentadmissionform.uploadMotherFingerPrint();
	//
	// log.info("============= Finished tcUploadMotherFingerPrint_AfterClear
	// Test===========");
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedMotherPhoto_AfterClear
	// Test===========");
	//
	// studentadmissionform.viewUploadedMotherPhoto();
	//
	// log.info("============= Finished tcViewUploadedMotherPhoto_AfterClear
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_MotherPhoto_AfterClear Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	//
	// try {
	// log.info("============= Starting tcViewUploadedMotherSign_AfterClear
	// Test===========");
	//
	// studentadmissionform.viewUploadedMotherSign();
	//
	// log.info("============= Finished tcViewUploadedMotherSign_AfterClear
	// Test===========");
	...
	// try {
	// log.info("============= Starting
	// tcCloseOpenedUploadedImagePopUp_MotherSign_AfterClear Test===========");
	//
	// studentadmissionform.closeOpenedUploadedImagePopUp();
	//
	// log.info("============= Finished
	...
	// try {
	// log.info("============= Starting
	// tcViewUploadedMotherFingerPrint_AfterClear Test===========");
	//
	// studentadmissionform.viewUploadedMotherFingerPrint();
	//
	// log.info("============= Finished
	...
	// @Test(priority = 124)
	// public void
	// tcCloseOpenedUploadedImagePopUp_MotherFingerPrint_AfterClear() {
	//
	// try {
	// log.info(
	// "============= Starting
	...
	//
	// try {
	// log.info("============= Strting tcClickOnSubmitButton_Documents
	// Test===========");
	//
	// studentadmissionform.clickOnSubmitButton_Documents();
	//
	// log.info("============= Finished tcClickOnSubmitButton_Documents
	// Test===========");
	...
	//
	// try {
	// log.info("============= Strting tcClickOnOkSuccessButton
	// Test===========");
	//
	// studentadmissionform.clickOnOkSuccessButton();
	//
	// log.info("============= Finished tcClickOnOkSuccessButton
	// Test===========");
