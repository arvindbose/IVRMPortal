...
public class Exam_MarksEntry_After_MarksCalculation extends TestBase {
	...
	public void clickOnCancelButton_ToCancelSubmission() throws Exception {
			...
			log("Clicked on Cancel button pop up window to Cancel sumit marks and object is:- "
					+ btn_Cancel_PopUp.toString());
			
	}

	public void clickOnUpdateItButton_ToUpDateMarks() throws Exception {
	
			clickOnButton(btn_YesUpdateIt);
			log("Clicked on Yes Update it button pop up window to update marks and object is:- "
					+ btn_YesUpdateIt.toString());
			Thread.sleep(1000);
	}
