 ...
 * 
 */
package com.test.automation.uiAutomation.selfRegistration;
 ...
 *
 */
public class SelfRegistrationProductionBCEHS extends TestBase{
	
public static final Logger log = Logger.getLogger(SelfRegistrationProductionBCEHS.class.getName());
	...
	@FindBy(xpath="(//body[@id='style-4']//div/form/div[1]/label)[1]")
	WebElement image_upload;
	
	@FindBy(xpath="(//body[@id='style-4']//div/form/div[2]/div/input)[1]")
	WebElement txt_Name;
	
	@FindBy(xpath="(//body[@id='style-4']//div/form/div[3]/div[1]/input)[1]")
	WebElement txt_RegEmail;
	
	@FindBy(xpath="(//body[@id='style-4']//div/form/div[6]/div[1]/input)[1]")
	WebElement txt_MobileNumber;
	
	@FindBy(xpath="(//body[@id='style-4']//div/form/div[9]/div/input)[1]")
	WebElement txt_UserName;
	
	@FindBy(xpath="(//body[@id='style-4']//div/form/div[10]/div/input)[1]")
	WebElement txt_Password;
	
	@FindBy(xpath="(//body[@id='style-4']//div/form/div[11]/div/input)[1]")
	WebElement txt_ConfirmPassword;
	
	@FindBy(xpath="(//body[@id='style-4']//div/form/div[12]/div[1]/button)[1]")
	WebElement btn_Register;
	
	@FindBy(xpath="(//body[@id='style-4']//div/form/div[12]/div[2]/button)[1]")
	...
	public SelfRegistrationProductionBCEHS(WebDriver driver) {
		this.driver=driver;
