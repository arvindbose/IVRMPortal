 ...
 *
 */
public class StudentRegistrationSelf  extends TestBase{
	
public static final Logger log = Logger.getLogger(StudentRegistrationSelf.class.getName());
	...
	public StudentRegistrationSelf(WebDriver driver) {
		this.driver=driver;
