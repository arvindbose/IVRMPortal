 ...
 * 
 */
package com.test.automation.uiAutomation.BCEHS_PreAdmission;
 ...
 *
 */
public class PreAdmission_InterviewSchedule_OralTest_Schedule_AutoSelect12Hr_BCEHS extends TestBase {

	public static final Logger log = Logger
			.getLogger(PreAdmission_InterviewSchedule_OralTest_Schedule_AutoSelect12Hr_BCEHS.class.getName());
	...
	@FindBy(xpath = "//div[@class='box box-primary']//table/thead/tr/th[2]")
	WebElement btnSortSchName;
	
	

	public PreAdmission_InterviewSchedule_OralTest_Schedule_AutoSelect12Hr_BCEHS(WebDriver driver) {
		this.driver = driver;
	...
	public void navigateTo_InterviewSchedule_OralTestSchedule_BGHS() {
	...
	public void resetFilledOralTestScheduleForm() throws Exception {
	...
	public void minimizeOralTestSchedule() throws Exception {
		btnMin_MaxOralTestSchedule.click();
		log("Minimize oral schedule test page and object is:-" + btnMin_MaxOralTestSchedule.toString());
		Thread.sleep(2000);
	}

	public void maximizeOralTestSchedule() throws Exception {
		btnMin_MaxOralTestSchedule.click();
		log("Maximize oral schedule test page and object is:-" + btnMin_MaxOralTestSchedule.toString());
		Thread.sleep(2000);
	}

	public void minimizeStudnetList() throws Exception {

		btnMin_MaxStudentList.click();
		log("Minimize Student list page and object is:-" + btnMin_MaxStudentList.toString());
		Thread.sleep(2000);
	}
	...
	public void maximizeStudentList() throws Exception {
		...
		btnMin_MaxStudentList.click();
		log("Maximize Student list page and object is:-" + btnMin_MaxStudentList.toString());
		Thread.sleep(2000);
	}
	
	public void minimizeOralTestScheduleList() throws Exception {
		btnMin_MaxOralTestScheduleList.click();
		log("Minimize oral schedule test List page and object is:-" + btnMin_MaxOralTestScheduleList.toString());
		Thread.sleep(2000);
	}

	public void maximizeOralTestScheduleList() throws Exception {
		btnMin_MaxOralTestScheduleList.click();
		log("Maximize oral schedule test List page and object is:-" + btnMin_MaxOralTestScheduleList.toString());
		Thread.sleep(1000);
	}
	...
	public void clickOnCancelButton() throws Exception {
		...
		btnCancel.click();
		log("Cancel button is clicked to clear the oral test schedule data and object is:-" + btnCancel.toString());
		Thread.sleep(3000);
	}
