 ...
 *
 */
public class Admission_Form_BCEHS_BaldwinURL extends TestBase {

	public static final Logger log = Logger.getLogger(Admission_Form_BCEHS_BaldwinURL.class.getName());
...
//	WebElement btnStudent_Admission;
	 ...
	 @FindBy(xpath = "//span[contains(text(),'Application Form')]/following::li[1]")
...
//	WebElement btnAdmForm_BCEHS;
	...
	public Admission_Form_BCEHS_BaldwinURL(WebDriver driver) {
		this.driver = driver;
	...
	public void navigateToAdmission_Form_BCEHS() throws Exception {
		...
		waitForElement(driver, 10, btnForm_Admission);

		btnForm_Admission.click();
		log("Clicked on Student Admission Button and object is:-" + btnForm_Admission.toString());
		waitForElement(driver, 10, btnForm_AdmissionInside);
		Thread.sleep(3000);
		
		btnForm_AdmissionInside.click();
		log("Clicked on admission form BCEHS Button and object is:-" + btnForm_AdmissionInside.toString());
